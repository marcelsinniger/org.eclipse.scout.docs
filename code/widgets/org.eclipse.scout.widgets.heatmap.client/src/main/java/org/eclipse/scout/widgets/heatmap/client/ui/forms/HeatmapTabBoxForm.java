...
import org.eclipse.scout.widgets.heatmap.client.ui.forms.HeatmapTabBoxForm.MainBox.CloseButton;
import org.eclipse.scout.widgets.heatmap.client.ui.forms.HeatmapTabBoxForm.MainBox.TabBox;
import org.eclipse.scout.widgets.heatmap.client.ui.forms.HeatmapTabBoxForm.MainBox.TabBox.GroupBox.CenterXField;
import org.eclipse.scout.widgets.heatmap.client.ui.forms.HeatmapTabBoxForm.MainBox.TabBox.GroupBox.CenterYField;
import org.eclipse.scout.widgets.heatmap.client.ui.forms.HeatmapTabBoxForm.MainBox.TabBox.GroupBox.HeatmapField;
import org.eclipse.scout.widgets.heatmap.client.ui.forms.HeatmapTabBoxForm.MainBox.TabBox.GroupBox.IntensityField;
import org.eclipse.scout.widgets.heatmap.client.ui.forms.HeatmapTabBoxForm.MainBox.TabBox.GroupBox.XField;
import org.eclipse.scout.widgets.heatmap.client.ui.forms.HeatmapTabBoxForm.MainBox.TabBox.GroupBox.YField;
import org.eclipse.scout.widgets.heatmap.client.ui.forms.HeatmapTabBoxForm.MainBox.TabBox.GroupBox.ZoomLevelField;
import org.eclipse.scout.widgets.heatmap.client.ui.forms.HeatmapTabBoxForm.MainBox.TabBox.TopBox.BlubbrField;

@Order(100001.0)
public class HeatmapTabBoxForm extends AbstractForm implements IAdvancedExampleForm {

  private P_ViewParameterListener m_viewParameterListener = new P_ViewParameterListener();

  public HeatmapTabBoxForm() {
    super();
  }
  ...
  public class MainBox extends AbstractGroupBox {
    ...
    @Order(-1000)
    @ClassId("42ee9278-5143-4056-b30b-7c612210e862")
    public class TabBox extends AbstractTabBox {

      @Order(0)
      @ClassId("1b486cce-0691-428d-84e9-1b79eddd3db5")
      public class TopBox extends AbstractGroupBox {
        ...
        @Order(1000)
        @ClassId("1c2b2a29-8440-4a0b-af4a-41df260053eb")
    ...
    @Order(60)
    @ClassId("d73635a0-84cf-45fb-801b-73f6fe83e1e5")
